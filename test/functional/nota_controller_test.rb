...
class NotaControllerTest < ActionController::TestCase
  ...
  test "should create notum" do
    assert_difference('Notum.count') do
      post :create, notum: { data: @notum.data, empresa: @notum.empresa, numero: @notum.numero, valor: @notum.valor }
    end
  ...
  test "should update notum" do
    put :update, id: @notum, notum: { data: @notum.data, empresa: @notum.empresa, numero: @notum.numero, valor: @notum.valor }
    assert_redirected_to notum_path(assigns(:notum))
  end
